...
function CreateTier1HouseFurnished(spawn, isBackdoor)
	...
	table.insert(objects, bathDelta)
	table.insert(objects, bathmirror)
	table.insert(objects, beerbot)
	...
	table.insert(objects, stool)
	table.insert(objects, chair4)
	table.insert(objects, chair5)
	table.insert(objects, chair6)
	table.insert(objects, plant4)
	table.insert(objects, storage)
	table.insert(objects, storage2)
	table.insert(objects, basketmess)
	table.insert(objects, lampStand2)
	table.insert(objects, plant5)
	table.insert(objects, plant6)
	table.insert(objects, basket)
	table.insert(objects, wardrobe)
	table.insert(objects, basket2)
	table.insert(objects, basket3)
	table.insert(objects, basket4)
	table.insert(objects, wardrobe2)
	table.insert(objects, basket5)
	table.insert(objects, switch)
	table.insert(objects, table2)
	table.insert(objects, lamp3)
	table.insert(objects, laundry)
	table.insert(objects, ashtray)
	table.insert(objects, candle1)
	table.insert(objects, candle2)
	table.insert(objects, candle3)
	table.insert(objects, woodbowl)
	table.insert(objects, tablod)
	table.insert(objects, tapeplayer)
	table.insert(objects, woodbowl2)
	table.insert(objects, sculpt)
	table.insert(objects, jewlry)
	table.insert(objects, basket6)
	table.insert(objects, basket7)
	table.insert(objects, basket8)
	table.insert(objects, basket9)
	table.insert(objects, bowl)
	table.insert(objects, breadbin)
	table.insert(objects, knifeblock)
	table.insert(objects, toaster)
	table.insert(objects, wok)
	table.insert(objects, plant5)
	table.insert(objects, tumbler)
	table.insert(objects, wisky)
	table.insert(objects, tissue)
	table.insert(objects, pants)
	table.insert(objects, pants2)
	table.insert(objects, hairdryer)
    ...
    if not isBackdoor then
        TeleportToInterior(spawn.x + 3.69693000, spawn.y - 15.080020100, spawn.z + 1.5, 0)
    else
