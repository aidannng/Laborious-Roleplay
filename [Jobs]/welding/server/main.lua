...
RegisterServerEvent('esx_welding:GiveItem')
AddEventHandler('esx_welding:GiveItem', function()
...
RegisterServerEvent('esx_welding:startVente')
AddEventHandler('esx_welding:startVente', function()
...
RegisterServerEvent('esx_welding:stopVente')
AddEventHandler('esx_welding:stopVente', function()
