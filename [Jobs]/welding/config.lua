...
-- Laborious Roleplay Public Script FiveM
-- "by Rayfield"
-- DO NOT TOUCH ANYTHING YOU DONT RECOGNISE.
...
Config.nameJob                    = "welding"
Config.platePrefix                = "WELD"
Config.Locale                     = 'fr'

Config.Vehicles = {
	car = {
		Spawner = 1,
		Label = 'Welding Company Car',
		Hash = "riata",
		Livery = 0,
		Trailer = "none",
	}	
...
Config.Zones = {
  ...
  Cloakroom = {
    Pos     = {x = 2670.78, y = 1626.33, z = 23.53},
    Size    = {x = 1.5, y = 1.5, z = 0.3},
    Color   = {r = 75, g = 122, b = 184},
    Type    = 1,
	BlipSprite = 566,
	BlipColor = 46,
	BlipName = "Welding",
  ...
  VehicleSpawner = {
	Pos   = {x = 2676.85, y = 1622.57, z = 23.48},
  ...
  VehicleDeleter = {
	Pos   = {x = 2667.64, y = 1632.18, z = 23.57},
	Size  = {x = 3.0, y = 3.0, z = 0.3},
    Color   = {r = 75, g = 122, b = 184},
	Type  = 1,
  ...
  Vente = {
	Pos   = {x = 2670.68, y = 1621.97, z = 23.5},
    Size    = {x = 1.5, y = 1.5, z = 0.3},
    Color   = {r = 75, g = 122, b = 184},
	Type  = 1,

	ItemTime = 500,
	ItemDb_name = "pay_welding",
	ItemName = "Pay Slip",
	ItemMax = 45,
	ItemAdd = 1,
	ItemRemove = 1,
...
Config.Pool = {
	...
	--[[ { [ 'x' ] = 	 2683.74	, [ 'y' ] = 	2861.64	, [ 'z' ] = 	36.57	},
{ [ 'x' ] = 	 2751.83	, [ 'y' ] = 	1426.38	, [ 'z' ] = 	20.82	}, ]]
