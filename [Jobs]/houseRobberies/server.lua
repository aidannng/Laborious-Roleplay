...
local robbableItems = {
 ...
 [3] = {chance = 3, id = 'scratchoff', name = 'Lottery Ticket', quantity = math.random(1, 3)}, -- really common
 [4] = {chance = 5, id = 'weed_pooch', name = 'Bag of Weed', quantity = 1}, -- rare
 [5] = {chance = 4, id = '2ct_gold_chain', name = '2CT Gold Chain (P)', quantity = 1}, -- rare
 ...
 [13] = {chance = 3, id = 'nokia_phone', name = 'Nokia Phone (P)', quantity = 1}, -- rare
...
AddEventHandler('houseRobberies:giveMoney', function()
 ...
 TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = 'You found $'..cash, })
end)
