...
$(document).keyup(function(e) {
    if (e.keyCode === 27) {
        ...
        $.post('https://labrp_jobsCore/close', JSON.stringify({}));
...
function hireperson(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://labrp_jobsCore/hire', JSON.stringify({job: currentBossMenuJob, id: id}));
}
...
function withdrawAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://labrp_jobsCore/withdraw', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function givebonus(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://labrp_jobsCore/givebonus', JSON.stringify({identifier: identifier, amount: amount, job: currentBossMenuJob}));
}
...
function depositAmount(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://labrp_jobsCore/deposit', JSON.stringify({job: currentBossMenuJob, amount: amount}));
}
...
function fire(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://labrp_jobsCore/fire', JSON.stringify({identifier: identifier, job: currentBossMenuJob}));
...
function promote(t) {
    ...
    playClickSound();
        ...
        $("#main_container").fadeOut("slow", function() {
          ...
          $.post('https://labrp_jobsCore/setrank', JSON.stringify({identifier: identifier, rank: rank, job: currentBossMenuJob}));
...
window.addEventListener('message', function(event) {
    ...
    $(".addjob").click(function() {
        ...
        if ($(this).text().replace(/ /g, '') != 'SELECTED') {
            ...
            $(this).text('SELECTED');
            $.post('https://labrp_jobsCore/addjob', JSON.stringify({
