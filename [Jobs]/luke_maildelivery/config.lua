...
Config.Vehicles = {
    Boxville = {name = 'boxville2', label = 'Boxville Delivery Van', desc = 'Common post delivery van', pay = math.random(70, 130), delivery = Config.Deliveries.City},
    Speedo = {name = 'speedo', label = 'Speedo Van', desc = 'Faster van, does deliveries outside the city',  pay = math.random(100, 170), delivery = Config.Deliveries.State},
}
