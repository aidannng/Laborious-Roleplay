...
Config.PedList = {
	{
		model = `cs_hunter`, -- place holder, find a suitable ped and apply it here, adjust model flag in bt-targeting to relfect the new chosen model as well, there is a safety backup right behind the ped just incase.
		coords = vector4(-679.1,5839.9,17.3, 208.48), -- Cluckin' Bell Factory Paleto Office. -679.1, 5839.9, 17.3
