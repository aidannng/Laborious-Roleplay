...
rootMenuConfig =  {
    ...
    },
    {
        ...
        subMenus = {"general:putinvehicle", "general:escort", "medic:revive", "cuffs:remmask", "police:removeweapons", "police:frisk", "police:cuff"}
    },
    {
        id = "police-check",
...
newSubMenus = {
    ...
    ['general:escort'] = {
        title = "Escort",
        icon = "#general-escort",
        functionName = "esx_policejob:drag"
    },
    ...
    ['cuffs:cuff'] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
        functionName = "esx_policejob:softcuff"
    },
    ['cuffs:softcuff'] = {
        title = "Cuff",
        icon = "#cuffs-cuff",
...
RegisterNetEvent("esx:setJob")
AddEventHandler("esx:setJob", function(job, name, notify)
