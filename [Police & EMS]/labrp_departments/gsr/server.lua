...
AddEventHandler("gsr:doTest", function(target)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', target, { type = 'inform', text = "You are being GSR Tested", length = 4500})
end)
...
AddEventHandler("gsr:returnGSR", function(shotRecently, policeId)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', policeId, { type = 'inform', text = "The GSR Test has returned "..result, length = 4500})
end)

RegisterNetEvent("search:notif")
AddEventHandler("search:notif", function(target)
	TriggerClientEvent('mythic_notify:client:SendAlert', target, { type = 'inform', text = "You're being searched", length = 4500})
end)

RegisterNetEvent("rob:notif")
AddEventHandler("rob:notif", function(target)
	TriggerClientEvent('mythic_notify:client:SendAlert', target, { type = 'inform', text = "You're being robbed!", length = 4500})
end)