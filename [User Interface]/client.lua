    ...
    while true do
        ...
        if canSearch then
            ...
            for i = 1, #dumpsters do
                ...
                if dist < 1.8 then
                    TriggerEvent('cd_drawtextui:ShowUI', 'show', '<strong>[E]</strong> Search', 'red')
                    if IsControlJustReleased(0, 38) then
                        for i = 1, #searched do
                            ...
                            elseif i == #searched and not dumpsterFound then
                                ...
                                exports["reload-skillbar"]:taskBar(5000,math.random(5,15))
...
function startSearching(time, dict, anim, cb)
    ...
    exports["cn-taskbar"]:taskBar(time, "Searching Dumpster")
    local ped = GetPlayerPed(-1)
