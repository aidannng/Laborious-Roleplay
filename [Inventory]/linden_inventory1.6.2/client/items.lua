...
AddEventHandler('inventory:hotwheelpack', function(item, wait, cb)
	cb(true)
	Citizen.Wait(wait)
	TriggerEvent('linden_inventory:hotwheelpack')
end)
...
AddEventHandler('linden_inventory:hotwheelpack', function()
	exports["cn-taskbar"]:taskBar(1000, "Opening Pack...")
	Citizen.Wait(1000)
	TriggerEvent('labrp_hotwheels:hotwheelpack')
	print('triggered')
end)
