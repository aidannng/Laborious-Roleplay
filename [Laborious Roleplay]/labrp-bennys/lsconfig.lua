...
local colors = {
	...
	------Neon layout------
		neonlayout = {
			{name = "Front,Back and Sides", price = 2500},
		},
		--Neon color
		neoncolor = {
			{ name = "White", neon = {255,255,255}, price = 250},
			{ name = "Blue", neon = {0,0,255}, price = 250},
			{ name = "Electric Blue", neon = {0,150,255}, price = 250},
			{ name = "Mint Green", neon = {50,255,155}, price = 250},
			{ name = "Lime Green", neon = {0,255,0}, price = 250},
			{ name = "Yellow", neon = {255,255,0}, price = 250},
			{ name = "Golden Shower", neon = {204,204,0}, price = 250},
			{ name = "Orange", neon = {255,128,0}, price = 250},
			{ name = "Red", neon = {255,0,0}, price = 250},
			{ name = "Pony Pink", neon = {255,102,255}, price = 250},
			{ name = "Hot Pink",neon = {255,0,255}, price = 250},
			{ name = "Purple", neon = {153,0,153}, price = 250},
			{ name = "Brown", neon = {139,69,19}, price = 250},
		},
	...
	----Wheel accessories----
		wheelaccessories = {
			...
			{ name = "White Tire Smoke",smokecolor = {254,254,254}, price = 2000},
			{ name = "Black Tire Smoke", smokecolor = {1,1,1}, price = 2000},
			{ name = "Blue Tire Smoke", smokecolor = {0,150,255}, price = 2000},
			{ name = "Yellow Tire Smoke", smokecolor = {255,255,50}, price = 2000},
			{ name = "Orange Tire Smoke", smokecolor = {255,153,51}, price = 2000},
			{ name = "Red Tire Smoke", smokecolor = {255,10,10}, price = 2000},
			{ name = "Green Tire Smoke", smokecolor = {10,255,10}, price = 2000},
			{ name = "Purple Tire Smoke", smokecolor = {153,10,153}, price = 2000},
			{ name = "Pink Tire Smoke", smokecolor = {255,102,178}, price = 2000},
			{ name = "Gray Tire Smoke",smokecolor = {128,128,128}, price = 2000},
		},
	...
	-----------Horn----------
		[14] = {
			{name = "Truck Horn", mod = 0, price = 1250},
			--[[ {name = "Police Horn", mod = 1, price = 4062}, ]]
			{name = "Clown Horn", mod = 2, price = 1500},
	...
	----------Transmission---------
		[13] = {
			{name = "Street Transmission", mod = 0, price = 5500},
			{name = "Sports Transmission", mod = 1, price = 8000},
			{name = "Race Transmission", mod = 2, price = 11500},
		},
