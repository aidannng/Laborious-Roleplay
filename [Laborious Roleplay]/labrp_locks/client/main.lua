                ...
                if not hasKeys(plate) and not isHotwiring and not isSearching then
                    ...
                    if IsControlJustReleased(0, 47) and not isSearching and not hasBeenSearched(plate) then -- G
                        if hasBeenSearched(plate) then
                            ...
                            exports["cn-taskbar"]:taskBar(5000, "Searching Vehicle")
                            Citizen.Wait(5000)
                            isSearching = false
                            ...
                            if rnd == 4 then
                                ...
                                exports["cn-taskbar"]:taskBar(6000, "Searching Vehicle")
                                Citizen.Wait(6000)
                                isSearching = false
...
AddEventHandler('onyx:beginHotwire', function(plate)
    ...
    exports["cn-taskbar"]:taskBar(time, "Hotwiring [Stage 1]")
    ...
    exports["cn-taskbar"]:taskBar(time, "Hotwiring [Stage 2]")
    ...
    exports["cn-taskbar"]:taskBar(time, "Hotwiring [Stage 3]")
            ...
            if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, entPos.x, entPos.y, entPos.z, false) < 3.5 then
                ...
                if IsControlJustReleased(0, 38) then
                    ...
                    if rand == 1 then
                        ...
                        --exports["cn-taskbar"]:taskBar(3600, "Taking Keys")
                        Wait(3600)
