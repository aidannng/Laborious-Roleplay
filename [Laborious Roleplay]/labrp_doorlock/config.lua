...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	lockpick = false,
	authorizedJobs = { ['ambulance']=0, ['police']=0, ['fbi']=0 },		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	-- audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
	-- autoLock = 1000
...
-- sonora_frontdoor1
table.insert(Config.DoorList, {
	authorizedJobs = { ['sonora']=0 },
	lockpick = false,
	maxDistance = 2.5,
	locked = true,
	audioRemote = false,
	doors = {
		{objHash = 1335309163, objHeading = 45.000003814697, objCoords = vector3(-168.3825, 914.7927, 235.8074)},
		{objHash = 1335309163, objHeading = 225.0, objCoords = vector3(-166.546, 916.6292, 235.8074)}
 },
	slides = false,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	lockpick = false,
	objCoords = vector3(-149.0257, 895.4813, 235.7626),
	audioRemote = false,
	fixText = false,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	lockpick = false,
	objCoords = vector3(-165.0408, 899.7982, 233.5634),
	audioRemote = false,
	fixText = false,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	lockpick = false,
	objCoords = vector3(-151.8321, 891.2762, 233.5634),
	audioRemote = false,
	fixText = false,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	lockpick = false,
	objCoords = vector3(-177.3052, 905.954, 239.0822),
	audioRemote = false,
	fixText = false,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	lockpick = false,
	objCoords = vector3(-150.7657, 890.3089, 239.1148),
	audioRemote = false,
	fixText = false,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	lockpick = false,
	objCoords = vector3(-151.8549, 909.7842, 235.8096),
	audioRemote = false,
	fixText = false,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
-- Steve's Pent Bedroom
table.insert(Config.DoorList, {
	garage = false,
	maxDistance = 2.0,
	objHeading = 69.999961853027,
	locked = true,
	objHash = 1026320033,
	objCoords = vector3(-271.6624, -727.1618, 125.6251),
	audioRemote = false,
	items = { 'stevecard' },
	fixText = false,
	lockpick = false,
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	objCoords = vector3(147.7325, -1703.024, 29.55688),
	objHash = 1427451548,
	locked = true,
	lockpick = false,
	fixText = false,
...
table.insert(Config.DoorList, {
	...
	maxDistance = 2.0,
	locked = true,
	objCoords = vector3(154.8065, -1702.975, 23.00434),
	garage = false,
	fixText = false,
	slides = false,
	authorizedJobs = { ['ballas']=7 },
	objHeading = 320.0,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	-- audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
...
-- Ballas Mech Mechanical
table.insert(Config.DoorList, {
	objCoords = vector3(-112.8056, -1790.932, 24.29576),
	locked = true,
	objHeading = 49.978630065918,
	authorizedJobs = { ['ballas']=5 },
	garage = false,
...
table.insert(Config.DoorList, {
	...
	lockpick = false,
	audioRemote = false,
	objHeading = 319.96530151367,
	garage = false,
	maxDistance = 2.0,
	authorizedJobs = { ['ballas']=5 },
	objCoords = vector3(-106.6524, -1796.523, 21.92531),
	fixText = false,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	-- audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
...
table.insert(Config.DoorList, {
	...
	lockpick = false,
	audioRemote = false,
	objHeading = 319.85110473633,
	garage = false,
	maxDistance = 2.0,
	authorizedJobs = { ['ballas']=5 },
	objCoords = vector3(-103.6429, -1799.054, 21.92445),
	fixText = false,		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	-- audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
...
table.insert(Config.DoorList, {
	...
	garage = true,
	authorizedJobs = { ['record']=0, ['galaxy']=0   },
...
table.insert(Config.DoorList, {
	...
	audioRemote = false,
	doors = {
		{objHash = 1650276170, objHeading = 324.39575195313, objCoords = vector3(-995.2607, -269.9999, 39.18408)},
		{objHash = 1650276170, objHeading = 144.3957824707, objCoords = vector3(-993.15, -271.5092, 39.18408)}
 },
	authorizedJobs = { ['record']=0, ['galaxy']=0   },		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
table.insert(Config.DoorList, {
	...
	authorizedJobs = { ['record']=2, ['galaxy']=0   },		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	-- audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
	-- autoLock = 1000
...
table.insert(Config.DoorList, {
	...
	locked = false,
	doors = {
		{objHash = 661758796, objHeading = 250.04852294922, objCoords = vector3(300.0308, -583.7263, 42.28401)},
		{objHash = -487908756, objHeading = 250.10284423828, objCoords = vector3(299.2278, -585.9323, 42.28401)}
 },
	authorizedJobs = { ['ambulance']=0, ['police']=0, ['fbi']=0 },		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
...
table.insert(Config.DoorList, {
	...
	locked = false,
	doors = {
		{objHash = -487908756, objHeading = 69.784461975098, objCoords = vector3(357.3348, -589.3868, 27.79682)},
		{objHash = 661758796, objHeading = 70.006050109863, objCoords = vector3(356.5311, -591.5957, 27.79682)}
 },
	authorizedJobs = { ['ambulance']=0, ['police']=0, ['fbi']=0 },		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
