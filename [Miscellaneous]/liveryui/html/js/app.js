...
dollar.CloseAyarMenu = function() {
    ...
    $.post('https://liveryui/CloseMenu:NuiCallback',JSON.stringify({data: true}));
};
...
$('#market-on').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/livery:1', JSON.stringify({}));
...
$('#garaj-on').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/livery:2', JSON.stringify({}));
...
$('#sapka-on').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/livery:0', JSON.stringify({}));
        document.getElementById("market-on").checked =  0;
        document.getElementById("benzinlik-on").checked =  0;
        document.getElementById("garaj-on").checked =  0;
...
$('#benzinlik-on').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/livery:3', JSON.stringify({}));
        document.getElementById("market-on").checked =  0;
        document.getElementById("garaj-on").checked =  0;
        document.getElementById("sapka-on").checked = 0;
    }
...
$('#dollar-bagg').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/extra:2', JSON.stringify({}));
...
$('#dollar-glass').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/extra:1', JSON.stringify({}));    }
    else{
        $.post('https://liveryui/extra:-1', JSON.stringify({}));    }
});
$('#dollar-bracelet').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/extra:4', JSON.stringify({}));
    }
    else{
        $.post('https://liveryui/extra:-4', JSON.stringify({}));
    }
...
$('#dollar-gloves').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/extra:3', JSON.stringify({}));
    }
    else{
        $.post('https://liveryui/extra:-3', JSON.stringify({}));
    }
...
$('#dollar-watch').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/extra:5', JSON.stringify({}));
    }
    else{
        $.post('https://liveryui/extra:-5', JSON.stringify({}));
    }
...
$('#dollar-necklace').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/extra:6', JSON.stringify({}));
    }
    else{
        $.post('https://liveryui/extra:-6', JSON.stringify({}));
    }
...
$('#dollar-Earring').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/extra:8', JSON.stringify({}));
    }
    else{
        $.post('https://liveryui/extra:-8', JSON.stringify({}));
    }
...
$('#dollar-vest').on('change',function(){
    if(this.checked){
        $.post('https://liveryui/extra:7', JSON.stringify({}));
    }
    else{
        $.post('https://liveryui/extra:-7', JSON.stringify({}));
    }
