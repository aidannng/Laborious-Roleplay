...
BBGarages.Functions = {
    TriggerNUI = (function(onVehicle, name, data, key)
        if key == 'garages' then
            BBGarages.Functions.tprint(BBGarages.Functions.GetNearbyVehicles(true))
            ...
            end, BBGarages.Functions.GetNearbyVehicles(true), #BBGarages.Functions.GetFreeSlots(name), name)
