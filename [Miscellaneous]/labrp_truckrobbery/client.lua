...
AddEventHandler('animation:hack', function()
    ...
    local data = {displayCode = '10-68', description = 'Bank Truck Disturbance', isImportant = 1, recipientList = {'police', 'fbi'}, length = '15000', infoM = 'fas fa-truck', info = 'Bank Truck Robbery'} --
    local dispatchData = {dispatchData = data, caller = 'Security Personnel', coords = playerCoords}
